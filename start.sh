...
#SBATCH --job-name=qwen_erm_translate
#SBATCH --error=/userspace/bma/qwen_erm_translate_err.log
#SBATCH --output=/userspace/bma/qwen_erm_translate.log
...
#SBATCH --no-requeue
#SBATCH -o qwen_erm_translate.log
