...
#SBATCH --job-name=mid_birm
#SBATCH --error=/userspace/bma/gpt2_birm_mid_err.log
#SBATCH --output=/userspace/bma/gpt2_birm_mid.log
...
python -u pretraining/something_mid.py
